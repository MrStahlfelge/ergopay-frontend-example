...
public class BurningPresenter extends Presenter<BurningPresenter.MyView, BurningPresenter.MyProxy> {

    interface MyView extends View {
    }

    @ProxyStandard
    @NameToken(NameTokens.BURN_TOKEN)
    interface MyProxy extends ProxyPlace<BurningPresenter> {
    }
