...
public class SpendBoxPresenter extends Presenter<SpendBoxPresenter.MyView, SpendBoxPresenter.MyProxy> {
    interface MyView extends View {
    }

    @ProxyStandard
    @NameToken(NameTokens.SPEND_TOKEN)
    interface MyProxy extends ProxyPlace<SpendBoxPresenter> {
    }
